...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lk220203006/CRProtocolManager"
  ...
  s.author             = { "Charon" => "lk220203006@126.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/lk220203006/CRProtocolManager.git", :tag => "#{s.version}" }
